...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    PRONOUN = 258,                 /* PRONOUN  */
    COMMON_NOUN = 259,             /* COMMON_NOUN  */
    ARTICLE = 260,                 /* ARTICLE  */
    ADJECTIVE = 261,               /* ADJECTIVE  */
    VERB = 262,                    /* VERB  */
    PERIOD = 263,                  /* PERIOD  */
    IS = 264,                      /* IS  */
    ARE = 265,                     /* ARE  */
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_COMMON_NOUN = 4,                /* COMMON_NOUN  */
  YYSYMBOL_ARTICLE = 5,                    /* ARTICLE  */
  YYSYMBOL_ADJECTIVE = 6,                  /* ADJECTIVE  */
  YYSYMBOL_VERB = 7,                       /* VERB  */
  YYSYMBOL_PERIOD = 8,                     /* PERIOD  */
  YYSYMBOL_IS = 9,                         /* IS  */
  YYSYMBOL_ARE = 10,                       /* ARE  */
  YYSYMBOL_WAS = 11,                       /* WAS  */
  YYSYMBOL_WERE = 12,                      /* WERE  */
  YYSYMBOL_AM = 13,                        /* AM  */
  YYSYMBOL_YYACCEPT = 14,                  /* $accept  */
  YYSYMBOL_sentences = 15,                 /* sentences  */
  YYSYMBOL_sentence = 16,                  /* sentence  */
  YYSYMBOL_simple_sentence = 17,           /* simple_sentence  */
  YYSYMBOL_noun_phrase = 18,               /* noun_phrase  */
  YYSYMBOL_helping_verb = 19,              /* helping_verb  */
  YYSYMBOL_adjective_phrase = 20           /* adjective_phrase  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "PRONOUN",
  "COMMON_NOUN", "ARTICLE", "ADJECTIVE", "VERB", "PERIOD", "IS", "ARE",
  "WAS", "WERE", "AM", "$accept", "sentences", "sentence",
  "simple_sentence", "noun_phrase", "helping_verb", "adjective_phrase", YY_NULLPTR
};
...
{
      12,    19,    13,    14,    15,    16,    17,     9,    11,     1,
       1,     2,     2,     7,    20,     8,    10
};

static const yytype_int8 yycheck[] =
{
       7,     4,     9,    10,    11,    12,    13,     0,     8,     3,
       3,     5,     5,     4,     6,     6,     3
};
...
{
       0,     3,     5,    15,    16,    17,    18,     4,     6,     0,
      16,     8,     7,     9,    10,    11,    12,    13,    19,     4,
       6,    20
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* sentence: simple_sentence PERIOD  */
#line 33 "Q2.y"
                           { printf("Valid Sentence.\n"); }
#line 1168 "y.tab.c"
    break;

  case 5: /* simple_sentence: noun_phrase VERB  */
#line 37 "Q2.y"
                     { 
        check_main_verb_agreement((yyvsp[-1].str), (yyvsp[0].str)); 
...
#line 1178 "y.tab.c"
  ...
  case 6: /* simple_sentence: noun_phrase helping_verb adjective_phrase  */
#line 42 "Q2.y"
                                                { 
        check_verb_agreement((yyvsp[-2].str), (yyvsp[-1].str)); 
...
#line 1188 "y.tab.c"
  ...
  case 7: /* noun_phrase: ARTICLE COMMON_NOUN  */
#line 50 "Q2.y"
                        { (yyval.str) = (yyvsp[0].str); }
#line 1194 "y.tab.c"
    break;

  case 8: /* noun_phrase: ARTICLE ADJECTIVE COMMON_NOUN  */
#line 51 "Q2.y"
                                    { (yyval.str) = (yyvsp[0].str); }
#line 1200 "y.tab.c"
    break;

  case 9: /* noun_phrase: PRONOUN  */
#line 52 "Q2.y"
              { (yyval.str) = (yyvsp[0].str); }
#line 1206 "y.tab.c"
    break;

  case 10: /* helping_verb: IS  */
#line 56 "Q2.y"
       { (yyval.str) = (yyvsp[0].str); }
#line 1212 "y.tab.c"
    break;

  case 11: /* helping_verb: ARE  */
#line 57 "Q2.y"
          { (yyval.str) = (yyvsp[0].str); }
#line 1218 "y.tab.c"
    break;

  case 12: /* helping_verb: WAS  */
#line 58 "Q2.y"
          { (yyval.str) = (yyvsp[0].str); }
#line 1224 "y.tab.c"
    break;

  case 13: /* helping_verb: WERE  */
#line 59 "Q2.y"
           { (yyval.str) = (yyvsp[0].str); }
#line 1230 "y.tab.c"
    break;

  case 14: /* helping_verb: AM  */
#line 60 "Q2.y"
         { (yyval.str) = (yyvsp[0].str); }
#line 1236 "y.tab.c"
    break;

  case 15: /* adjective_phrase: ADJECTIVE  */
#line 64 "Q2.y"
              { free_string((yyvsp[0].str)); }
#line 1242 "y.tab.c"
    break;
